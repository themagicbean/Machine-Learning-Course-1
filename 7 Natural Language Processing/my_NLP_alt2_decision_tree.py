...
# Predicting the Test set results - gotta change to regressor
y_pred = regressor.predict(X_test)
# this does not work because "classification metrics can't handle a 
